...

{
  ...
  # Nota: system.stateVersion è impostato per host in hosts/<nome>/configuration.nix,
  # perché registra la release NixOS con cui ciascun host è stato installato la prima volta.
}
```
